"use client"; // Для клиентского компонента, чтобы useState работал

import { useState } from 'react'; // Базовый импорт для стейта

// Интерфейс для данных погоды от OpenWeatherMap (упрощённый)
...
export default function Home() {
  ...
  const [weather, setWeather] = useState<WeatherData | null>(null); // Типизированный state
